...
#define OER_SAVE_INTERVAL 3600
#define OER_ALLOWED_QUOTE_TIME_USEC 600000
#define OER_FORCE_FLUSH 100
#define Q_NICK "Q"
...
#define OER_HELP "For the oer user manual go to http://oer.equnet.org/um.php"
...
#define OER_VERSION "oer version 1.0-65 (oerperl 1.0.1)"
...
struct ls_wrapstruct {
	time_t at;
	char *str1;
	char *str2;
	char *str3;
	struct ls_wrapstruct *prev;
	struct ls_wrapstruct *next;
};
